...
<Card>
  ...
  <Card.Body>
  <Image className="w-75" src="https://1z30b13mfvdj2ixk6z3i8rfx-wpengine.netdna-ssl.com/wp-content/uploads/2020/10/champagne-velvet-lunaria-wedding-inspiration-05-740x994.jpg" rounded />
    <Card.Title>Prospect House Wedding</Card.Title>
    <Card.Text>
    
    </Card.Text>
    <Button target="_blank" href="https://ruffledblog.com/prospect-house-wedding-inspiration-yellow-palette/" variant="dark">See the set on Ruffled</Button>
  </Card.Body>
</Card>
...
<Card>
  ...
  <Card.Body>
  <Image className="w-75" src="https://static1.srcdn.com/wordpress/wp-content/uploads/2020/08/Christine-Evangelista-and-Masked-Figure-in-Fear-The-Walking-Dead.jpg?q=50&fit=crop&w=960&h=500" rounded />
