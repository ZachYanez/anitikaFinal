  ...
  return (
    <div className="shadow">
      <Carousel className="printworkPics shadow">
        <Carousel.Item>
          <img className="d-block w-100" src={Anitaka1} alt="First slide" />
          <Carousel.Caption>
            <h3></h3>
            <p></p>
          </Carousel.Caption>
        ...
        <Carousel.Item>
          <img className="d-block w-100" src={Anitaka7} alt="Second slide" />
        ...
        <Carousel.Item>
          <img className="d-block w-100" src={Anitaka6} alt="Third slide" />
        ...
        <Carousel.Item>
          <img className="d-block w-100" src={Anitaka9} alt="Third slide" />
